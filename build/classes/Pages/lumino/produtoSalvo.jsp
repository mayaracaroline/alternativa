			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" id="cadastrarProduto" action="/livraria/CadastrarProduto" method="POST">
								...
								<div class="form-group">
									...
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="1,Administração"> Administração
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="2,Artes e fotografia"> Artes e fotografia
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="3,Autoajuda">Autoajuda
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="4,Biografia">Biografia
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="5,Contos e crônicas">Contos e crônicas
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="6,Didáticos">Didáticos
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="7,Direito">Direito
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="8,Ficção fantasiosa">Ficção fantasiosa
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="9,HQs">HQs
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="10,Poesia">Poesia
										</label>
									</div>
									<div class="checkbox">
										<label>
											<input  name="genero" type="checkbox" value="11,Romance">Romance
										</label>
									</div>
									<label>Editora:</label>
									...
									<button id="operacao" name="operacao" value="SALVAR" type="submit" class="btn btn-primary">Salvar</button>																
								</div>	
